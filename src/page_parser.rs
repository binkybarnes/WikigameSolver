...
pub fn build_title_maps(
    path: &str,
) -> anyhow::Result<(HashMap<String, u32>, HashMap<u32, String>)> {
    ...
    let mut title_to_id: HashMap<String, u32> = HashMap::with_capacity(estimated_matches);
    let mut id_to_title: HashMap<u32, String> = HashMap::with_capacity(estimated_matches);
